...
```javascript
   ...
   "showYexings"                             // 展示野心时
   "trigger"                                 // 触发时
   "useCardToExcluded"                       // 使用卡牌到排除时
   "useCardToPlayer"                         // 使用卡牌到玩家时
   "useCardToPlayered"                       // 使用卡牌到玩家时
   "useCardToTarget"                         // 使用卡牌到目标时
   "useCardToTargeted"                       // 使用卡牌到目标时
   "video"                                   // 放视频时
   "waitForPlayer"                           // 等待玩家时
   "wuxianhuoli_reward"                      // 无限火力奖励时
   "year_limit_pop"                          // 年限弹出时
   "addShownCards"                           // 添加展示卡牌时
   "arrangeTrigger"                          // 安排触发时
   "chooseDrawRecover"                       // 选择抽牌恢复时
   "debateCallback"                          // 辩论回调时
   "delay"                                   // 延迟时
   "delayx"                                  // 延迟时
   "dieAfter"                                // 死亡之后的相关信号触发器。
   "enterGame"                               // 进入游戏时
   "gainMultiple"                            // 多重获得时
   "game"                                    // 游戏时
   ...
   "loadMode"                                // 加载模式时
   "logSkill"                                // 记录技能时
   "logSkillBegin"                           // 记录技能开始时的相关信号触发器。
   "orderingDiscard"                         // 排序弃置时
   "phase"                                   // 阶段时
   "phaseUse"                                // 阶段使用时
   "qianlidanji_replace"                     // 千里单骑替换时
   "replacePlayer"                           // 替换玩家时
   "replacePlayerSingle"                     // 替换单个玩家时
   "replacePlayerTwo"                        // 替换两个玩家时
   "shidianyanluo_huanren"                   // 十殿阎罗换人时
   "swapHandcards"                           // 交换手牌时
   "waitForPlayer"                           // 等待玩家时
   "wuxianhuoli_reward"                      // 无限火力奖励时
